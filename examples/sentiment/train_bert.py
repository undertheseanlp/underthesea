...
from examples.sentiment.train_gpt2 import MultiLabelClassificationDatamodule
from underthesea.datasets.uit_absa_hotel.uit_absa_hotel import UITABSAHotel


class BertForTextClassification(pl.LightningModule):
...
def main(config: DictConfig) -> None:
    ...
    model = BertForTextClassification(gpt2, num_labels)
