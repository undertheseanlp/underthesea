...
class Tokenizer4Bert:
    ...
    def text_to_sequence_and_mask(self, text):
        encoded = self.tokenizer.encode_plus(
            ...
            # return_tensors="pt"  # to return output in Torch tensors
        )
...
class ABSADataset:
    def __init__(self, fname, tokenizer):
        ...
        for i in tqdm(range(1, len(lines), 4), desc="Load and preprocess data: "):
            ...
            # aspect_input_id, _ = tokenizer.text_to_sequence_and_mask(" ".join(aspect).replace("#", " "))
