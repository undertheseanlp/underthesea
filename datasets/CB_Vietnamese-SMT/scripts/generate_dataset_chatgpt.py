...
if __name__ == '__main__':
    ...
    #     openai=openai)
    # user_prompt = "Generate rasa chatbot dataset with 10 stories (senarios), each story at leat 7 turns between a Vietnamese chatbot and a user about love topic"
