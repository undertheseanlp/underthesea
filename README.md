...
🌊 **A Pytorch NLP library.** Underthesea is backed by one of most popular deep learning libraries, [Pytorch](https://pytorch.org/), make it easy to train your own models and experiment with new approcaches using Underthesea embeddings and classes.
